...
export default defineConfig({
  resolve: {
    alias: {
      // lily-design-system-web-components-picker-bar depends on these
      ...
      "lily-design-system-web-components-theme-picker": fileURLToPath(
        new URL(
          "./lily-design-system-web-components-theme-picker/dist/index.js",
          import.meta.url,
        ),
      ),
      "lily-design-system-web-components-locale-picker": fileURLToPath(
        new URL(
          "./lily-design-system-web-components-locale-picker/dist/index.js",
          import.meta.url,
        ),
      ),
      "lily-design-system-web-components-text-size-picker": fileURLToPath(
        new URL(
          "./lily-design-system-web-components-text-size-picker/dist/index.js",
          import.meta.url,
        ),
      ),
      "lily-design-system-web-components-share-picker": fileURLToPath(
        new URL(
