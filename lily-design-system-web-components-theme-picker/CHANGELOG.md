...
**Package renamed: `lily-design-system-web-components-theme-picker` → `@lilydesignsystem/web-components-theme-picker`.** npm scoped packages
...
relative to `lily-design-system-web-components-theme-picker`'s last published version (`0.1.0`);
...
(`@lilydesignsystem/html-theme-picker`), differing only in the tag it
...
First release under the name `@lilydesignsystem/web-components-theme-picker`.
